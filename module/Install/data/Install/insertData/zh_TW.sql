...
INSERT INTO dbshop_admin_group_extend (admin_group_id, admin_group_name, `language`) VALUES (1, '管理員', 'zh_TW');

INSERT INTO dbshop_user_group (group_id) VALUES (1);
INSERT INTO dbshop_user_group_extend (group_id, group_name, `language`) VALUES (1, '普通會員', 'zh_TW');
...
(7, '順豐速運', '國內服務質量最好，速度最快的速運公司。', '', 255, 'T', '0', 1);
